...
# ARG_OPTIONAL_SINGLE([nRepeat],,[number of parallel repeats],[5])
# ARG_OPTIONAL_SINGLE([nParallel],,[number to run at the same time],[1])
...
# ARG_DEFAULTS_POS
# ARG_HELP([Run additional experiments in folder. Total number of runs is nRepeat x nParallel.])
# ARGBASH_GO
